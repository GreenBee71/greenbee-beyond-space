          ...
          children: [
            Row(
              children: [
                ...
                Text(
                  title,
                  style: const TextStyle(fontFamily: 'Paperlogy', color: AppTheme.textHigh, fontWeight: FontWeight.w500, fontSize: 15),
                ),
              ],
            ),
            ...
            Text(
              description,
              style: const TextStyle(fontFamily: 'Paperlogy', color: AppTheme.textMedium, fontSize: 13, height: 1.5),
            ),
            ...
            Align(
              ...
              child: TextButton(
                ...
                child: Text(
                  actionLabel,
                  style: const TextStyle(fontFamily: 'Paperlogy', color: AppTheme.accentMint, fontWeight: FontWeight.w500, fontSize: 13),
                ),
              ),
            ),
          ],
