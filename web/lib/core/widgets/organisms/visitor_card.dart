    ...
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: Text(
          ...
          style: const TextStyle(fontFamily: 'Paperlogy', color: AppTheme.textMedium),
        ),
        trailing: Chip(
          label: Text(visitor.status, style: const TextStyle(fontFamily: 'Paperlogy', fontSize: 10)),
          backgroundColor: visitor.status == 'APPROVED' 
              ? AppTheme.accentMint.withOpacity(0.2) 
              : Colors.orange.withOpacity(0.2),
          labelStyle: TextStyle(fontFamily: 'Paperlogy', 
            color: visitor.status == 'APPROVED' ? AppTheme.accentMint : Colors.orange,
          ),
        ),
      ),
    );
