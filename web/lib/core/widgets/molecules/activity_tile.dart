      ...
      child: GlassContainer(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    subtitle, 
                    style: const TextStyle(fontFamily: 'Paperlogy', color: AppTheme.textMedium, fontSize: 13)
                  ),
                ],
              ),
            ),
            Text(
              time, 
              style: const TextStyle(fontFamily: 'Paperlogy', fontSize: 11, color: AppTheme.textLow)
            ),
          ],
        ),
      ),
