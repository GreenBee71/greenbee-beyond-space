          ...
          children: [
            ...
            if (actionLabel != null && onActionPressed != null)
              TextButton(
                ...
                child: Text(
                  actionLabel!, 
                  style: TextStyle(fontFamily: 'Paperlogy', color: AppTheme.accentMint, fontSize: 14.sp, fontWeight: FontWeight.w500) // Increased from 13.sp
                ),
              ),
          ],
        ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        subtitle,
                        style: TextStyle(fontFamily: 'Paperlogy', color: AppTheme.textMedium, fontSize: 14.sp, height: 1.4), // Increased from 14.sp
                        maxLines: 2,
