      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(title, style: const TextStyle(fontFamily: 'Paperlogy', color: Colors.white70, fontSize: 14)),
              if (isPaid)
                Container(
                  ...
                  child: const Text('납부 완료', style: TextStyle(fontFamily: 'Paperlogy', color: AppTheme.accentMint, fontSize: 12)),
                ),
            ],
          ),
          const SizedBox(height: 12),
          Text(amount, style: const TextStyle(fontFamily: 'Paperlogy', color: Colors.white, fontSize: 26, fontWeight: FontWeight.w500)),
